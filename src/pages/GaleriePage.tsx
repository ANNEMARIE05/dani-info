...
const GaleriePage = () => {
  ...
  return (
    <div className="space-y-8 sm:space-y-10">
      ...
      <section
        className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-7"
        data-aos="fade-up"
        data-aos-delay="100"
      >
        {projetsDanie.map((projet) => (
          ...
          >
            <div className="relative h-52 sm:h-64 overflow-hidden">
              ...
              />
              <span className="absolute top-3 left-3 rounded-full bg-black/70 px-3 py-1 text-[10px] sm:text-[11px] uppercase tracking-wide text-gray-100">
                {projet.categorie}
              </span>
              <span className="absolute bottom-3 right-3 rounded-full bg-black/70 px-3 py-1 text-[10px] sm:text-[11px] uppercase tracking-wide text-gray-100">
            ...
            <div className="p-4 sm:p-5 space-y-1.5">
              <h2 className="font-titre text-sm sm:text-lg font-semibold">
                {projet.titre}
              </h2>
