...
export default function PortfolioDaniel() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-r from-orange-600 to-orange-500 text-white py-2 px-4">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center text-xs sm:text-sm gap-2">
          ...
          <div className="text-center sm:text-right">
            <span className="font-medium">Infographiste freelance pour marques ambitieuses.</span>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-fade-in">
              ...
              <p className="text-2xl text-amber-800 font-semibold">Infographiste Professionnel</p>
              ...
              <div className="flex flex-wrap gap-4">
                <button
                  onClick={() => naviguerVers('contact')}
                  className="bg-gradient-to-r from-orange-600 to-orange-500 text-white px-8 py-3 rounded-full hover:shadow-xl transition-all shadow-lg transform hover:scale-105"
                >
                  Me Contacter
                </button>
                <button
                  onClick={() => naviguerVers('galerie')}
                  className="border-2 border-orange-600 text-orange-600 px-8 py-3 rounded-full hover:bg-orange-50 transition-all transform hover:scale-105"
                >
                  Voir Mes Travaux
                </button>
              </div>
            ...
            <div className="relative animate-float">
              ...
              <div className="relative w-full h-96 bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl shadow-2xl flex items-center justify-center text-white overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent"></div>
                <span className="text-8xl font-bold relative z-10">D</span>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-orange-50 to-amber-50 p-6 rounded-2xl border border-orange-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Mon Expertise</h3>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-orange-50 to-amber-50 p-8 rounded-2xl border border-orange-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Compétences</h3>
                <div className="grid grid-cols-2 gap-4">
                  {competences.map((comp, index) => (
                    <div 
                      key={index} 
                      className="bg-white p-4 rounded-xl shadow-sm text-center text-gray-700 font-medium hover:shadow-md transition-shadow border border-orange-100"
                      style={{
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                <div className="bg-gradient-to-br from-orange-600 to-orange-500 text-white p-6 rounded-2xl shadow-lg transform hover:scale-105 transition-transform">
                  <div className="text-3xl font-bold">5+</div>
                  <div className="text-sm mt-2">Années d'Expérience</div>
                </div>
                <div className="bg-gradient-to-br from-amber-700 to-amber-600 text-white p-6 rounded-2xl shadow-lg transform hover:scale-105 transition-transform">
                  <div className="text-3xl font-bold">200+</div>
                  <div className="text-sm mt-2">Projets Réalisés</div>
                </div>
                <div className="bg-gradient-to-br from-orange-600 to-orange-500 text-white p-6 rounded-2xl shadow-lg transform hover:scale-105 transition-transform">
                  <div className="text-3xl font-bold">100%</div>
                  <div className="text-sm mt-2">Satisfaction Client</div>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Section Galerie */}
      <section id="galerie" className="py-20 bg-gradient-to-br from-orange-50 via-white to-amber-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Mes <span className="bg-gradient-to-r from-orange-600 to-orange-500 bg-clip-text text-transparent">Créations</span>
            </h2>
            <div className="w-24 h-1 bg-gradient-to-r from-orange-600 to-orange-500 mx-auto rounded-full mb-6"></div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {projets.map((projet, index) => (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-orange-600 transition-colors">{projet.titre}</h3>
          ...
          <div className="text-center mt-12">
            <button
              onClick={() => naviguerVers('contact')}
              className="bg-gradient-to-r from-orange-600 to-orange-500 text-white px-8 py-3 rounded-full hover:shadow-xl transition-all shadow-lg transform hover:scale-105 inline-flex items-center gap-2"
            >
              <Briefcase size={20} />
              Démarrer un Projet
            </button>
      ...
      <section id="contact" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-8">
              <div className="flex items-start space-x-4 group">
                <div className="bg-orange-100 p-4 rounded-full group-hover:bg-orange-600 transition-colors">
                  <Phone className="text-orange-600 group-hover:text-white transition-colors" size={24} />
                </div>
                <div>
              ...
              <div className="flex items-start space-x-4 group">
                <div className="bg-orange-100 p-4 rounded-full group-hover:bg-orange-600 transition-colors">
                  <Mail className="text-orange-600 group-hover:text-white transition-colors" size={24} />
                </div>
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Email</h3>
                  <p className="text-gray-600">contact@danie-info.design</p>
                </div>
              </div>

              <div className="flex items-start space-x-4 group">
                <div className="bg-orange-100 p-4 rounded-full group-hover:bg-orange-600 transition-colors">
                  <MapPin className="text-orange-600 group-hover:text-white transition-colors" size={24} />
                </div>
                <div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-amber-50 p-8 rounded-2xl shadow-lg border border-orange-100">
              <div className="space-y-6">
                <div>
                  <label className="block text-gray-700 font-medium mb-2">Nom Complet</label>
                  <input
                    type="text"
                    className="w-full px-4 py-3 border border-orange-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-600 bg-white"
                ...
                <button
                  type="button"
                  className="w-full bg-gradient-to-r from-orange-600 to-orange-500 text-white py-3 rounded-xl hover:shadow-xl transition-all shadow-lg font-medium transform hover:scale-105"
                >
                  Envoyer le Message
                </button>
              </div>
      ...
      <footer className="bg-gradient-to-br from-amber-900 to-amber-800 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 text-center md:text-left">
            ...
            <div>
              <h4 className="font-bold mb-4 text-orange-300">Navigation</h4>
              <div className="space-y-2">
                {['accueil', 'apropos', 'galerie', 'contact'].map((item) => (
                  <button
                    key={item}
                    onClick={() => naviguerVers(item)}
                    className="block text-orange-200 hover:text-orange-400 transition-colors capitalize mx-auto md:mx-0"
                  >
                    {item === 'apropos' ? 'À propos' : item}
                  </button>
                ))}
      ...
      {btnHautVisible && (
        <button
          onClick={allerEnHaut}
          className="fixed bottom-24 right-6 bg-gradient-to-br from-amber-900 to-amber-800 text-white p-3 rounded-full shadow-2xl hover:from-orange-600 hover:to-orange-500 transition-all hover:scale-110 z-50"
